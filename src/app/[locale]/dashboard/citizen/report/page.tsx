...
export default function ReportIssuePage() {
    ...
    if (success) {
        return (
            <>
                <Head>
                    <title>Report Submitted - GeoFix</title>
                    <meta name="description" content="Your infrastructure issue report has been submitted successfully" />
                </Head>
                                ...
                                <Card>
                                    <CardContent className="p-12 text-center">
                                        ...
                                        <p className="text-gray-600 dark:text-gray-400 mb-6">
                                            Your ticket has been reported and will be reviewed by the relevant authorities.
                                        </p>
    ...
    return (
        <>
            <Head>
                <title>Report Infrastructure Issue - GeoFix</title>
                <meta name="description" content="Report infrastructure issues in your area" />
            </Head>
