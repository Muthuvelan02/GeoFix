...
export default function ContractorTicketsPage() {
    ...
    const loadData = async () => {
        try {
            ...
            console.log('📊 Data loaded:', { tickets: ticketsData.length, workers: workersData.length });
    ...
    return (
        <>
            <Head>
                <title>Assigned Tickets - GeoFix Contractor Dashboard</title>
                <meta name="description" content="Manage and assign tickets to your workers" />
            </Head>
