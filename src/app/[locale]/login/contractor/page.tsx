  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userRole !== 'ROLE_CONTRACTOR') {
        // User is not a contractor - show generic error
        ...
        <Card className="shadow-xl border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
          <CardHeader className="space-y-4 text-center">
            ...
            <div className="mx-auto w-fit">
              ...
              >
                ...
                {t("login.roles.contractor.label")}
              </div>
            </div>
          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="w-full px-3 py-2 pr-10 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-orange-500 dark:bg-gray-800 dark:text-white"
                    required
                    disabled={loading}
              ...
              <Button
                type="submit"
                className="w-full py-2 px-4 bg-[#F39C12] hover:bg-orange-600 text-white font-medium rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              >
                {loading ? (
                  ...
                  t("login.signin", { role: t("login.roles.contractor.label") })
                )}
              </Button>
            </form>
