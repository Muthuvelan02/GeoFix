        ...
        switch (role) {
            case 'admin':
                return [
                    ...
                    { name: 'Ticket Management', href: `/${locale}/dashboard/admin/tickets`, icon: AlertTriangle },
            ...
            default:
                return [
                    ...
                    { name: 'Report Ticket', href: `/${locale}/dashboard/citizen/report`, icon: AlertTriangle },
                    { name: 'My Tickets', href: `/${locale}/dashboard/citizen/tickets`, icon: FileText },
                    { name: 'Track Tickets', href: `/${locale}/dashboard/citizen/track`, icon: MapPin },
