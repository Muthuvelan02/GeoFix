  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userRole !== 'ROLE_ADMIN') {
        // User is not an admin - show generic error
        ...
        <Card className="shadow-xl border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="w-full px-3 py-2 pr-10 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-green-500 dark:bg-gray-800 dark:text-white"
                    required
                    disabled={loading}
              ...
              <Button
                type="submit"
                className="w-full py-2 px-4 bg-[#27AE60] hover:bg-green-700 text-white font-medium rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              >
                {loading ? (
                  ...
                  t("login.signin", { role: t("login.roles.admin.label") })
                )}
              </Button>
            </form>
