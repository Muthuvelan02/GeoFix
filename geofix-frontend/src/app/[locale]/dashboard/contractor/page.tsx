    ...
    const loadData = async () => {
        try {
            ...
            const newStats = {
                ...
                assignedToContractor: ticketsData.filter(t => t.status === 'ASSIGNED_TO_CONTRACTOR').length,
                assignedToWorker: ticketsData.filter(t => t.status === 'ASSIGNED_TO_WORKER').length,
